...
fun box(): String {
    ...
    if (targets.toSet() != setOf(java.lang.annotation.ElementType.FIELD, java.lang.annotation.ElementType.METHOD))  { // <- UNRESOLVED_REFERENCE when analyze for JS backend
        return targets.toList().toString()
    }
    return "OK"
}
