...
object Instrumenter {
    fun instrumentJars() {
        ...
        val compilerJar = "$pathToGradleDir/kotlin-compiler/1.4.0/962125a9b1bd61cceaf79740919b153c12a6ecd9/kotlin-compiler-1.4.0_backup.jar" to "$pathToGradleDir/kotlin-compiler/1.4.0/456958114e183d1bf468f80d23b5ca9023b596af/kotlin-compiler-1.4.0-sources.jar"
    ...
    """.trimIndent())
        ...
        for (jar in jarsToSerialize) {
            val instrumenter = JarSourceCodeInstrumenter(jar.first, listOf(jar.second), jar.first.substringBefore(".jar") + "-inst.jar")
